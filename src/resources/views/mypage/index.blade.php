...
<div class="tabs">
    <a href="{{ route('mypage.index', ['tab' => 'sell', 'keyword' => $currentKeyword]) }}" class="tab {{ $activeTab === 'sell' ? 'active' : '' }}">出品した商品</a>
    <a href="{{ route('mypage.index', ['tab' => 'buy', 'keyword' => $currentKeyword]) }}" class="tab {{ $activeTab === 'buy' ? 'active' : '' }}">購入した商品</a>
</div>
